    ...
    return (
        <div>
            <form>
                ...
                <input type='text' value={formData.bio === undefined ? '' : formData.bio} onChange={(e) => handleChange(e)} name='bio' maxLength={60} />
            ...
            <button onClick={() => setEditProfileModalOpen(false)}>Close</button>
        </div>
    )
}
