...
export const ProfileHeader = (props) => {
    ...
    return (
        <div className='profile-header'>
            {isProfilePicAvailable(profileData) === false ? <div className='profile-user-initials'>{userInitials(profileData)}</div> : <img src={profileData.profilePic} className='profile-pic' alt='profilePic'/>}
